...
The decoded example suggests that the language model of the decoder is currently dominating the acoustics of the listener.

My code is available in , with TensorBoard training curves in  
